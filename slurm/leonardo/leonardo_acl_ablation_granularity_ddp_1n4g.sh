...
# Ablation A2: granularity sweep (structure vs hardware)
# - BD-LoRA: N ∈ {1,2,4,8,16} (requires r % N == 0)
# - Group-Local: parameter-matched sweep over m-values
###############################################################################
#SBATCH --job-name=acl-gran-ddp-1n4g
...
OUTPUT_ROOT="${OUTPUT_ROOT:-runs/leonardo_acl_granularity_${SLURM_JOBID:-interactive}}"
